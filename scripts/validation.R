...
#   Objective                                                                                    #
#       Generate the arff files for validation and training, of the R1 partitions, to run    # 
#       in the clus.                                                                             # 
#   Parameters                                                                                   #
...
#       files .arff                                                                              #
##################################################################################################
validatePartitions <- function(number_folds, dataset_name, ds, id_part, folderResults){  
...
##################################################################################################
juntaResultados <- function(number_folds, dataset_name, ds, id_part, folderResults){
...
##################################################################################################
avalia <- function(number_folds, dataset_name, ds, id_part, folderResults){
...
##################################################################################################
juntaAvaliacoes <- function(number_folds, dataset_name, ds, id_part, folderResults){  
...
validate <- function(number_dataset, number_cores, number_folds, dataset_name, ds, folderResults){
  ...
  while(id_part<ds$gridn){
    ...
    cat("\n\n################################################################################################")
    cat("\n# VAL ID PART: Build and Validate Partitions                                                     #")
    timeBuild = system.time(resVP <- validatePartitions(number_folds, dataset_name, ds, id_part, folderResults))
    cat("\n################################################################################################\n\n")
    
    cat("\n\n################################################################################################")
    cat("\n# VAL ID PART: Matrix Correlation                                                                #")
    timeSplit = system.time(resGatherVal <- juntaResultados(number_folds, dataset_name, ds, id_part, folderResults)) 
    cat("\n################################################################################################\n\n")
    
    cat("\n\n################################################################################################")
    cat("\n# VAL ID PART:  evaluation Fold                                                                  #")
    timeAvalia = system.time(resEVal <- avalia(number_folds, dataset_name, ds, id_part, folderResults))
    cat("\n################################################################################################\n\n")
    
    cat("\n\n################################################################################################")
    cat("\n# VAL ID PART:  Gather Evaluation                                                                #")
    timeGather = system.time(resValEval <- juntaAvaliacoes(number_folds, dataset_name, ds, id_part, folderResults)) 
    cat("\n################################################################################################\n\n")
