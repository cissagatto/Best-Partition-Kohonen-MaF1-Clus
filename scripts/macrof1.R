cat("\n\n################################################################################################")
cat("\n# START SELECT BEST MACRO F1 PARTITION                                                           #")
cat("\n##################################################################################################\n\n") 
...
FolderRoot = ""
if (sistema[1] == "Linux"){
  FolderRoot = paste("/home/", sistema[7], "/Best-Partition-Kohonen-MacroF1", sep="")
} else {
  FolderRoot = paste("C:/Users/", sistema[7], "/Best-Partition-Kohonen-MacroF1", sep="")
}
...
# destino = paste("cloud:elaine/[2021]ResultadosExperimentos/Best-Partitions/R2/Macro-F1/", dataset_name, sep="")
# comando1 = paste("rclone -v copy ", origem, " ", destino, sep="")
# cat("\n", comando1, "\n") 
# a = print(system(comando1))
# a = as.numeric(a)
